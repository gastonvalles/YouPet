            ...
            <Formik
                ...
                validate={(values)=>{
                    ...
                    if(!values.lastname){
                        ...
                        errors.lastname='The last name can only be alphabetical characters'
                    }
                    if(!values.speciality){
                        errors.speciality='Please insert a speciality'
                    } else if(!/^[a-zA-ZÀ-ÿ\s]{1,40}$/.test(values.speciality)){
                        errors.speciality='The speciality can only be alphabetical characters'
                    }
                ...
                {({handleSubmit, values, handleChange, handleBlur, errors, touched})=>(
                    ...
                    <Form className="formulario" >
                        ...
                        <div>
                            ...
                            />
                            <ErrorMessage name='speciality'component={()=>(<div className='error'>{errors.speciality}</div>)}/>
                        </div>
